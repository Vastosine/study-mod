...
public class ModBlocks {
    ...
    public static final Block ALLOY_FURNACE = register("alloy_furnace", AlloyFurnaceBlock::new, BlockBehaviour.Properties.of().strength(6.0f, 6.0f).requiresCorrectToolForDrops());
